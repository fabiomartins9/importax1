  ...
  return (
    <Container className="max-w-2xl mx-auto p-10">
      ...
      <p className="mb-4">
        ...
        possamos coletar no site Importax, e outros sites que possuímos e
        operamos.
      </p>
      ...
      <p className="mb-4">
        ...
        informação que o Importax oferece no site e com caráter enunciativo, mas
        não limitativo:
      </p>
      <ul className="list-disc pl-4 mb-4">
        ...
        <li>Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Importax, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
      </ul>

      <p className="text-2xl font-bold mt-8 mb-4">Mais informações</p>
      <p className="mb-4">
      ...
      <p>Esta política é efetiva a partir de 13 de janeiro de 2024 às 18:52.</p>
    </Container>
  );
}
